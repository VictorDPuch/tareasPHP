...
$.fn.ddTableFilter = function(options) {
  ...
  return this.each(function() {
    ...
    $('th:visible', table).each(function(index) {
      ...
      var selectbox = $('<input type="text" class="form-control" placeholder=' + $(this).text() + '>');
      var values = [];
      var opts = [];
      ...
      selectbox.bind('change keyup', {column:col}, function(event) {
        var changeStart = new Date();
        var value = $(this).val();

        event.data.column.each(function() {
          if($(this).attr('ddtf-value') === value || value == '') {
