...
cargarProvincias();
          ...
          <div class="grid simple ">
            ...
            <div class="grid-body ">
             <div class="row form-row">
                ...
                <div class="col-md-12">
                <textarea  name="comentarios" style="resize:vertical;"  placeholder="Contenido..." class="form-control" rows="12"></textarea>
                </div>
             </div>
  ...
  <script src="https://cdn.tiny.cloud/1/g6rpd4wpkelqgqguxedbie1za1qjvlt9sfnllsgrsw2dln7m/tinymce/5/tinymce.min.js" referrerpolicy="origin"></script>

<script>
   tinymce.init({
   selector: 'textarea',
     plugins: 'print',
     toolbar: 'a11ycheck addcomment showcomments casechange checklist code formatpainter pageembed permanentpen table print',
